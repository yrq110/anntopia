...
import { CubicSpline, CubicParameterSpline, BoundaryCondition, createQuasiUniformKnots, createNonUniformKnots, HermiteSpline, CardinalSpline, BezierSpline, BSpline, NURBS, CatmullRomSpline } from '@anntopia/geometry'
...
<Playground>
  {
    () => {
      // import { CatmullRomSpline } from '@anntopia/geometry'
      const dataPoints = [
        50, 250,
        200, 150,
        100, 50,
      ...
      const spline = new CatmullRomSpline(dataPoints)
      const points = spline.getInterpolation()
      return  <Canvas points={dataPoints} lines={[points]}/>
    }
  }
